...
// Routing 로직:
// URL에 따라서 어떤 리소스 또는 로직을 기동해서 결과를
// 표시할 것인지 결정하는 로직
const appRoutes: Routes = [
  // 도메인/home 이라는 URL일 때, router-outlet 지점에
...
@NgModule({
  ...
  // 등록한 서비스들을 모듈 처리시 엥귤러가 객체로 만들고
  // 그것을 모듈레벨의 컨테이너에 보관한다.
  // 서비스는 전체 프로그램에서 단 1개만 만들고 재사용한다.
  providers: [ExperimentsService, StateService],
  bootstrap: [AppComponent]
})
export class AppModule { }

// declarations -> AppModule 모듈은 직접 5개의 컴포넌트들을 갖고 있다.
